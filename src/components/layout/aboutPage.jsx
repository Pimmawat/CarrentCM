                ...
                <div className="hero min-h-screen" style={{ backgroundImage: 'url(https://i.etsystatic.com/24786587/r/il/1e91c1/3462969636/il_570xN.3462969636_pc95.jpg)' }}>
                    ...
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-xl">
                            ...
                            <p className="mb-5 text-5xl">ยินดีต้อนรับ</p>
                            <p className='bm-5'> ร้านของเราตั้งอยู่ที่จังหวัดเชียงใหม่</p>
                            <p className='bm-5'> มีบริการให้เช่ารถ เอกสารง่าย ไม่ยุ่งยาก </p>
                            <p className='bm-5'>สะดวก ปลอดภัย บริการเป็นกันเอง</p>
                            ...
                            <div className="max-w-xl">
                                ...
                                <a className="btn glass btn-success text-white" href="tel://0931713860" target='_blank'><svg class="h-8 w-8 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>โทร</a>
                            </div>
                        </div>
                    </div>
                </div>
